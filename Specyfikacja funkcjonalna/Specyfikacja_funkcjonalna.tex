...
\item podany obiekt duplikuje współrzędnego innego obiektu lub punktu kluczowego:

\textit{Ignored DOM (2,39). The given object's coordinates are already used.}
\item podany punkt kluczowy duplikuje współrzędnego innego obiektu lub punktu kluczowego:
